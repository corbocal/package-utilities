...
final class Passwords
{
     ...
     * * MIN = 12
     * * MAX = 255
     * @param bool $special Sets if the password will contain non-alphanumeric characters.
     * @return string The password.
     */
    public static function generate(int $length = self::MIN_LENGTH, bool $special = false): string
    {
